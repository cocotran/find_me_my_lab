...
def scrape(ENCS_LOGIN_NAME, ENCS_PASSWORD):
    cookies = {
        ...
        '',
        '_ga':
        'GA1.2.1998562932.1611697475',
        'concordia-cookie':
        'nGOyP76CZ4eBOsPKhoLgIFyUFDkMgO-Z\\u0021802858945',
        'ExpirePage':
        'https://my.concordia.ca/psp/upprpr9/',
        'PS_LOGINLIST':
        'https://my.concordia.ca/upprpr9',
        'PS_TOKEN':
        'qQAAAAQDAgEBAAAAvAIAAAAAAAAsAAAABABTaGRyAk4AgQg4AC4AMQAwABTm8i7sJ0GIx2xIJ91DU3NV5VlSQWkAAAAFAFNkYXRhXXicZYtBDkBAEARrEUdv8AFiLZajA26yCXdv8S+P0/ZqOqnuzPTcQJYmxsifhDhloPlpwOEZpZ58YWejCBysnFwEZrpWtRZLFb1S8pGOWhsvOr1/edR9Ei28PWQNEQ==',
        'ps_theme':
        'node:EMPL portal:EMPLOYEE theme_id:PAPPBR_THEME_TANGERINE accessibility:N',
        'HPTabName':
        'CU_MY_FRONT_PAGE2',
        'HPTabNameRemote':
        '',
        'psback':
        '"url":"https%3A%2F%2Fmy.concordia.ca%2Fpsp%2Fupprpr9%2FEMPLOYEE%2FEMPL%2Fh%2F%3Ftab%3DCU_MY_FRONT_PAGE2" "label":"Home" "origin":"PIA"',
        'https%3a%2f%2fmy.concordia.ca%2fpsp%2fupprpr9%2femployee%2fempl%2frefresh':
        'list:%20%3Ftab%3Dcu_campus_services%7C%3Frp%3Dcu_campus_services%7C%3Ftab%3Dremoteunifieddashboard%7C%3Frp%3Dremoteunifieddashboard%7C%7C%7C',
        'PS_TOKENEXPIRE':
        '17_Feb_2021_23:07:58_GMT',
    }
    ...
    headers = {
        ...
        'Referer':
        'https://fis.encs.concordia.ca/helpdesk-cgi/available-hosts.cgi',
